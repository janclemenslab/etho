...
def load_sounds(playlist, fs, mirrorsound=True, attenuation=None):
    ...
    for name, listitem in playlist.iterrows():
        ...
        if listitem.stimFileName[:3] == 'SIN':  # SIN_FREQ_PHASE_DURATION
            ...
            wav_rate, x = wav.read(listitem.stimFileName)
            # scipy reads wave as int16 -32768:32767 - convert to float -1:1
