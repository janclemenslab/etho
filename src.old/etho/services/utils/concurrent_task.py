...
def Queue(maxsize: int = 0):
    ...
    sender.closed = sender._closed
    receiver = sender
    receiver.closed = receiver._closed
    return sender, receiver
...
class ConcurrentTask:
    ...
    def __init__(
        ...
        self.closed = self._receiver.closed
        self.receiver_closed = self._receiver.closed
        self.sender_closed = self._sender.closed
